import{a as z,b as A}from"./chunk-3KJZNRY2.js";import{Ca as w,Da as g,Ea as u,Fa as p,Ga as a,Ha as n,Ia as r,La as y,Ma as m,Na as b,U as d,Ua as C,V as h,Wa as f,Xa as S,Ya as _,Za as T,dc as D,ec as E,ha as t,ob as R,ta as v}from"./chunk-7UE6IFUK.js";function M(c,o){if(c&1){let i=y();a(0,"tw-chip",32),m("onRemove",function(){let s=d(i).$implicit,l=b();return h(l.onRemove(s))}),n()}if(c&2){let i=o.$implicit;p("label",i)("removable",!0)}}var I=class c{tags=["Angular","TypeScript","Tailwind","CSS"];inputTags=["React","Vue","Svelte"];onRemove(o){this.tags=this.tags.filter(i=>i!==o)}onTagAdded(o){console.log("Tag added:",o)}onTagRemoved(o){console.log("Tag removed:",o.value)}basicCode=`<tw-chip label="Default"></tw-chip>
