          ...
          <div class="p-6">
            ...
            <div class="space-y-6">
              @for (setting of filteredSettings(); track setting.id) {
                <div class="flex items-start justify-between gap-8 py-4 border-b border-slate-100 dark:border-slate-800">
                  <div class="flex-1">
                    <label [for]="setting.id" class="font-medium text-slate-900 dark:text-slate-100">
                      {{ setting.label }}
                    </label>
